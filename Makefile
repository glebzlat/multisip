...
RESOURCES_SRC = $(filter-out %.qrc, $(wildcard ${RESOURCES_DIR}/* ${RESOURCES_DIR}/icons/*))
RESOURCES_IN = ${RESOURCES_DIR}/resources.qrc
...
${RESOURCES_OUT}: ${RESOURCES_IN} ${RESOURCES_SRC}
